...
if "pretix_ebics" not in INSTALLED_APPS:  # type: ignore[name-defined]  # noqa: F405
    INSTALLED_APPS.append("pretix_ebics")  # type: ignore[name-defined]  # noqa: F405

# The import flow reuses pretix's bundled bank transfer plugin for matching.
if "pretix.plugins.banktransfer" not in INSTALLED_APPS:  # type: ignore[name-defined]  # noqa: F405
    INSTALLED_APPS.append("pretix.plugins.banktransfer")  # type: ignore[name-defined]  # noqa: F405
